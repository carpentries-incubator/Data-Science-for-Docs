...
- "---?"
objectives:
- "Describe some of the basic differences between data types."
- "Summarise the pros and cons for different spreadsheet applications for storing your data."
- "Demonstrate best practices for recording and formatting data in spreadsheets."
- "Understand the correspondence between spreadsheet cells, columns and rows and data observations and values."
- "Avoid the common mistakes when recording raw data."
- "Be confident in building their own spreadsheet to collect data under best practices."
keypoints:
- "Excel and spreadsheet tools are useful if data is well organised"
- "Try to think how data will be handled when imported"
---
