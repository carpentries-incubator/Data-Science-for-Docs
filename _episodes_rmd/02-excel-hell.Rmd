...
![](../assets/teaching_materials/src/images/data2csv-3.png)

We do ... (just add some white space and dividers)

![](../assets/teaching_materials/src/images/data2csv-2.png)

And all excel does is present it to us in an easy to use format.

![](../assets/teaching_materials/src/images/data2csv-1.png)
