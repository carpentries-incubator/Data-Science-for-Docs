...
# Instead, please edit 03-getting-data-into-r.md in _episodes_rmd/
source: Rmd
...
```
## Error in head(RCT): object 'RCT' not found
```
...
```
## Error in tail(RCT): object 'RCT' not found
```
...
```
## Error in as.data.frame(x): object 'RCT' not found
```
...
```
## Error in eval(expr, envir, enclos): object 'RCT' not found
```
