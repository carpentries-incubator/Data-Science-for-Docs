...
- Use basic stats terms accurately
- Have an intuition of how basic statistical tools work
- Avoid bad habits
...
- Reproducibility crisis -> cargo cult statistics
- More data != better science
- Really useful in all walks of life (QI, research)
